...
const Logo = ({ className = "", compact = false, size = 40 }) => (
  <Link to="/" aria-label="ResQPlate home" className={className} style={{ display: "inline-flex", alignItems: "center", gap: 10, color: "inherit", textDecoration: "none" }}>
    ...
    {!compact && <span style={{ fontFamily: "'Cabinet Grotesk', system-ui, sans-serif", fontSize: size * 0.5, fontWeight: 800, letterSpacing: "-.045em", lineHeight: 1 }}>ResQ<span style={{ color: "#52b788" }}>Plate</span></span>}
  </Link>
);
